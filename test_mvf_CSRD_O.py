...
cfg = Config('CSRD_O')  # CSRD_Virtual or CSRD_O
...
# dataset about
cfg.dataset_shuffle = True  # set false for CSRD, true for CSRD_O
cfg.train_random_seed = 0
cfg.train_num = 500  # 800 for CSRD, 500 for CSRD_O
cfg.test_num = 50   # 200 for CSRD, 50  for CSRD_O
cfg.gt_ratio = 1  # 0.212 for CSRD, 1 for CSRD-O
...
# loconet correct
cfg.bias_correct = True  # set true for CSRD_O, false for CSRD
cfg.x_bias = -1.7579
cfg.y_bias = -0.4667
...
cfg.loconet_pretrained_model_path = ('/home/nv/ws/GO-MVF/models/CSRD_O_test.pth')

cfg.load_resnet_model = True
cfg.resnet_pretrained_model_path = ('/home/nv/ws/GO-MVF/models/CSRD_O_test.pth')
