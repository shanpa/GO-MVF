...
cfg.only_test = False  # if only test, set to True
# draw
...
cfg.loconet_pretrained_model_path = ('/home/nv/ws/GO-MVF/models/pretrained_loconet_CSRD.pth')

cfg.load_resnet_model = False
